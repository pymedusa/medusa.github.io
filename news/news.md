...
For the anime fans we've added an option that allows you to separate your list of anime with the list of series using tabs in the home page. Besides that, this release focussus mostly around bugfixes and some preparation towards a new big feature coming shortly after this one.
